...
exports.api = exports.subscribeToTopic = exports.sendAppointmentStatusEmail = exports.sendAppointmentEmail = void 0;
...
exports.sendAppointmentStatusEmail = functions
    .region('us-central1')
    .runWith({
    timeoutSeconds: 300,
    memory: '256MB'
...
app.get('/shops', async (req, res) => {
    try {
        const snapshot = await admin.firestore()
            ...
            .get();
        const shops = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
...
app.get('/shops/:shopId', async (req, res) => {
    try {
        ...
        const shop = Object.assign({ id: doc.id }, doc.data());
...
app.get('/shops/:shopId/staff', async (req, res) => {
    try {
        ...
        const snapshot = await admin.firestore()
            ...
            .where('shopId', '==', shopId)
            .get();
        const staff = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
...
app.get('/search', async (req, res) => {
    try {
        ...
        const snapshot = await admin.firestore()
            ...
            .where('isActive', '==', true) // Sadece aktif işletmeler
            .get();
        let shops = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        // Kategori filtresi
        ...
        if (q && typeof q === 'string') {
            ...
            shops = shops.filter(shop => {
                var _a, _b, _c;
                return ((_a = shop.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchTerm)) ||
                    ((_b = shop.description) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(searchTerm)) ||
                    ((_c = shop.category) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes(searchTerm));
            });
        }
        // Lokasyon filtresi
        if (location && typeof location === 'string') {
            shops = shops.filter(shop => {
                var _a, _b, _c;
                return ((_a = shop.address) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(location.toLowerCase())) ||
                    ((_b = shop.district) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(location.toLowerCase())) ||
                    ((_c = shop.city) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes(location.toLowerCase()));
            });
        }
...
app.get('/shops/user/my-shops', authenticateUser, async (req, res) => {
    var _a;
    try {
...
app.post('/appointments', authenticateUser, async (req, res) => {
    ...
    try {
        ...
        const shopName = (shopData === null || shopData === void 0 ? void 0 : shopData.name) || 'Bilinmeyen İşletme';
        const shopAddress = ((_b = shopData === null || shopData === void 0 ? void 0 : shopData.location) === null || _b === void 0 ? void 0 : _b.address) || (shopData === null || shopData === void 0 ? void 0 : shopData.address) || 'Adres bilgisi bulunamadı';
        // Get service details
        ...
        const serviceName = (serviceData === null || serviceData === void 0 ? void 0 : serviceData.name) || 'Bilinmeyen Servis';
        const serviceDuration = (serviceData === null || serviceData === void 0 ? void 0 : serviceData.duration) || 60;
        ...
        if (staffId && staffId !== 'any') {
            ...
            if (staffDoc.exists) {
                ...
                appointmentData.staffName = (staffData === null || staffData === void 0 ? void 0 : staffData.name) || 'Bilinmeyen Personel';
            }
        }
        ...
        return res.status(201).json({
            success: true,
            data: Object.assign({ appointmentId: appointmentRef.id }, appointmentData)
        });
    }
    catch (error) {
...
app.get('/appointments/user', authenticateUser, async (req, res) => {
    var _a, _b, _c;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
        if (!userId) {
        ...
        for (const appointmentDoc of snapshot.docs) {
            ...
            const appointmentData = Object.assign({ id: appointmentDoc.id }, data);
            ...
            if (!data.shopName && data.shopId) {
                ...
                if (shopDoc.exists) {
                    ...
                    appointmentData.shopName = (shopData === null || shopData === void 0 ? void 0 : shopData.name) || 'Bilinmeyen İşletme';
                    appointmentData.shopAddress = ((_b = shopData === null || shopData === void 0 ? void 0 : shopData.location) === null || _b === void 0 ? void 0 : _b.address) || (shopData === null || shopData === void 0 ? void 0 : shopData.address) || 'Adres bilgisi bulunamadı';
                    appointmentData.shopImage = ((_c = shopData === null || shopData === void 0 ? void 0 : shopData.images) === null || _c === void 0 ? void 0 : _c.main) || (shopData === null || shopData === void 0 ? void 0 : shopData.image) || (shopData === null || shopData === void 0 ? void 0 : shopData.imageUrl);
                }
            }
            ...
            if (!data.serviceName && data.serviceId) {
                ...
                if (serviceDoc.exists) {
                    ...
                    appointmentData.serviceName = (serviceData === null || serviceData === void 0 ? void 0 : serviceData.name) || 'Bilinmeyen Servis';
                    appointmentData.serviceDuration = (serviceData === null || serviceData === void 0 ? void 0 : serviceData.duration) || 60;
                }
            }
...
app.get('/appointments/business/:shopId', authenticateUser, async (req, res) => {
    try {
        const { shopId } = req.params;
        const snapshot = await admin.firestore()
            .collection('appointments')
        ...
        for (const appointmentDoc of snapshot.docs) {
            ...
            if (data.serviceId) {
                ...
                if (serviceDoc.exists) {
                    const serviceData = serviceDoc.data();
                    serviceName = (serviceData === null || serviceData === void 0 ? void 0 : serviceData.name) || "Bilinmeyen Servis";
                }
            }
            appointments.push(Object.assign(Object.assign({ id: appointmentDoc.id }, data), { userName,
                userEmail,
                userPhone,
                serviceName }));
        }
...
app.put('/appointments/:appointmentId/status', authenticateUser, async (req, res) => {
    try {
        ...
        return res.json({ success: true, data: Object.assign({ id: appointmentId }, updateData) });
    }
    catch (error) {
        return res.status(500).json({ success: false, error: error.message });
    }
...
// Randevu iptal et
app.put('/appointments/:appointmentId/cancel', authenticateUser, async (req, res) => {
    var _a;
    try {
        const { appointmentId } = req.params;
...
app.post('/reviews', authenticateUser, async (req, res) => {
    ...
    try {
        ...
        const reviewData = {
            shopId,
            shopName: (shopData === null || shopData === void 0 ? void 0 : shopData.name) || 'Bilinmeyen İşletme',
            appointmentId: appointmentId || null,
            userId,
            userName: ((_b = req.user) === null || _b === void 0 ? void 0 : _b.name) || ((_c = req.user) === null || _c === void 0 ? void 0 : _c.email) || 'Kullanıcı',
            userPhoto: (_d = req.user) === null || _d === void 0 ? void 0 : _d.picture,
            rating,
            comment,
            isPublished: true,
            createdAt: admin.firestore.FieldValue.serverTimestamp(),
        ...
        return res.status(201).json({ success: true, data: Object.assign({ reviewId: reviewRef.id }, reviewData) });
    }
    catch (error) {
        return res.status(500).json({ success: false, error: error.message });
    }
...
app.get('/reviews/shop/:shopId', async (req, res) => {
    try {
        ...
        const snapshot = await admin.firestore()
            ...
            .get();
        let reviews = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        // Client-side'da tarihe göre sırala
        reviews = reviews.sort((a, b) => {
            var _a, _b;
            const dateA = ((_a = a.createdAt) === null || _a === void 0 ? void 0 : _a.toDate) ? a.createdAt.toDate() : new Date(a.createdAt || 0);
            const dateB = ((_b = b.createdAt) === null || _b === void 0 ? void 0 : _b.toDate) ? b.createdAt.toDate() : new Date(b.createdAt || 0);
...
app.get('/reviews/user', authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
        if (!userId) {
...
app.post('/messages', authenticateUser, async (req, res) => {
    ...
    try {
        ...
        const messageData = {
            shopId,
            senderId: userId,
            senderName: ((_b = req.user) === null || _b === void 0 ? void 0 : _b.name) || ((_c = req.user) === null || _c === void 0 ? void 0 : _c.email) || 'Kullanıcı',
        ...
        return res.status(201).json({ success: true, data: Object.assign({ messageId: messageRef.id }, messageData) });
    }
    catch (error) {
        return res.status(500).json({ success: false, error: error.message });
    }
...
app.get('/messages/user', authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
        if (!userId) {
        ...
        const snapshot = await admin.firestore()
            ...
            .get();
        let messages = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        // Client-side'da tarihe göre sırala
...
app.get('/messages/shop/:shopId', authenticateUser, async (req, res) => {
    var _a;
    try {
        const { shopId } = req.params;
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
...
app.get('/notifications/user', authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
        if (!userId) {
...
app.put('/profile', authenticateUser, async (req, res) => {
    ...
    try {
        ...
        if (userDoc.exists) {
            ...
            await userRef.set(Object.assign(Object.assign({}, updateData), { email: ((_b = req.user) === null || _b === void 0 ? void 0 : _b.email) || '', displayName: displayName || ((_c = req.user) === null || _c === void 0 ? void 0 : _c.name) || '', userType: 'user', createdAt: admin.firestore.FieldValue.serverTimestamp() }));
        }
...
// Favori ekle/çıkar
app.put('/profile/favorites/:shopId', authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
        const { shopId } = req.params;
        ...
        const favorites = (userData === null || userData === void 0 ? void 0 : userData.favorites) || [];
 ...
 */
app.post('/users/create-business-accounts', async (req, res) => {
    var _a, _b;
    try {
        ...
        for (const accountData of businessAccounts) {
            try {
                ...
                const userProfileData = {
                    ...
                    profile: {
                        avatar: ((_a = shopData.images) === null || _a === void 0 ? void 0 : _a.main) || "/placeholder.svg",
                        bio: `${accountData.shopName} işletme sahibi`,
                        location: ((_b = shopData.location) === null || _b === void 0 ? void 0 : _b.city) || "İstanbul"
                    },
                    settings: {
                        notifications: {
                            email: true,
...
app.put('/users/profile', authenticateUser, async (req, res) => {
    ...
    try {
        ...
        const updateData = Object.assign(Object.assign({}, profileData), { updatedAt: admin.firestore.FieldValue.serverTimestamp() });
        const userRef = admin.firestore().collection('users').doc(userId);
...
app.put('/users/preferences', authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.uid;
